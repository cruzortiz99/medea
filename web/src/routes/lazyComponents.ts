...
export const AlertAndFailure = React.lazy(() => import("../pages/AlertAndFailure"))
export const Order = React.lazy(() => import("../pages/Order"))
export const Budget = React.lazy(() => import("../pages/Budget"))
export const EquipmentHistory = React.lazy(() => import("../pages/EquipmentHistory"))
export const PreventiveMaintenance = React.lazy(() => import("../pages/PreventiveMaintenance"))
